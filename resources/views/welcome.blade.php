...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <h2 class="text-info">Ticketing Bus Inventory</h2>
            <form action="getReceipt" method="post">
                @csrf
                <input type="text" name="code" required id="code" class="form-control mt-4" placeholder="Code">
                ...
                <button class="btn btn-success btn-block mt-3 font-weight-bold">Get Receipt</button>
            </form>
        </div>
    </div>
